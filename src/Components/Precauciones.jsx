...
export const Precauciones = () => {
    return(
        <div className="flex flex-col pt-14 pb-14 bg-[#FAFAFA]">
            ...
            <div className='flex flex-row justify-center  md:gap-48'>
                <img src={ImgPrecauciones} alt="img-precauciones" className='object-contain hidden lg:block' />
                
                <div className="flex flex-col gap-10 ml-2 mr-4 md:mr-0 md:ml-0 mt-10">
